...
- refactoring status: viewer runtime extraction started; fullscreen/orientation, gyro, and floorplan/map now live in dedicated viewer modules
...
- static export now bundles the extracted viewer runtime modules (`viewer/runtime-ui.js`, `viewer/runtime-gyro.js`, `viewer/runtime-floorplan.js`)
